...
export const createEvent = async ({ title, coverImg, description, start_date, finish_date, categories, creator }) => {
  try {
    const newEvent = await databases.createDocument(
      ...
      ID.unique(),
      {
        title, coverImg, description, start_date, finish_date, categories, creator
      }
    );
